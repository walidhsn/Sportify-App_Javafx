            ...
            if (verif == null) {
                if (file != null) {
                    ...
                    try {
                        ...
                        Event e = new Event(id_owner, name, category, startDateTime, startDateTime, endDateTime, imageName, terrain_name, LocalDateTime.now());
                        result = es.createEvent(e);
                    ...
                    Event e = new Event(id_owner, name, category, startDateTime, startDateTime, endDateTime, "", terrain_name, LocalDateTime.now());
                    result = es.createEvent(e);
                    if (result.get(0).equals("ok")) {
                        verif = es.find_event(id_owner, name, terrain_name, startDateTime);
                        for (String item : selectedItems) {

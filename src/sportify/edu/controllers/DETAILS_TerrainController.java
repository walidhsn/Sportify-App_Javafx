 ...
 * @author WALID
 */
public class DETAILS_TerrainController implements Initializable {
   ...
   try {
    ...
    @FXML
    private void redirectToReservationList(ActionEvent event) {
        try {
           
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../gui/terrain/ListReservation_Terrain.fxml"));
            Parent root = loader.load();
            //UPDATE The Controller with Data :

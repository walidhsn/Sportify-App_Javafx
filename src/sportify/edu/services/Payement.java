...
public class Payement {
    private static final String STRIPE_API_KEY = "sk_test_51N1xBBKKqoNUJb640UnO0v4Hhgu9d8hc3mnbdCj26LBbolk5UJhQbBfR8N8sRlRs9Cs3G8z21qYhUQrNxJxpmHeW005fYdmk5m"; // your API secret key
    ...
    //public static boolean Paycom(String name, String mail, float total, String cardNumber, int month, int year, String cvc) throws StripeException {
        /*boolean result = false;
        int Conversion;
        //Conversion  Dt to Eur : 
        total = (float) ((total / 0.3) * 10);
        ...
        if (customers.getData().size() > 0) {
            ...
            Map<String, Object> cardParameter = new HashMap<String, Object>();
            cardParameter.put("number", cardNumber);
            cardParameter.put("exp_month", month);
